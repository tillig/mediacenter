...
- `The MakeMKV forum <http://www.makemkv.com/forum2/>`_ is a good place to search for answers. People run up against this and will generally post the answer for you.
- `The AVS Forum Blu-ray Info thread <http://www.avsforum.com/forum/150-blu-ray-software/760714-unofficial-blu-ray-audio-video-specifications-thread.html>`_ can sometimes help, though it's hard to read and the info there is dense.
...
- If all else fails, `this forum post tells you how to manually figure it out yourself using MakeMKV <http://www.makemkv.com/forum2/viewtopic.php?f=1&t=7680>`_.
