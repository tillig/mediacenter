...
I use Handbrake to convert my videos into :doc:`MKV format <../../formats/video>`.
...
I originally was an MP4/M4V guy due to the compatibility aspect. I am still a big fan of that compatibility, but I've since changed to MKV. It seems to be more flexible when it comes to things like multiple subtitles and dealing with emerging formats, and since my primary use case is streaming through Plex anyway, it works out.

I've also added an NVIDIA card to my Plex/ripping server which allows for better compression using H.265. To avoid falling back on CPU-based encoding, I avoid using any filters in the conversion unless absolutely necessary - doing that automatically engages the CPU again.

SD Settings
-----------
I have two SD presets - one for standard encoding, one specifically to deal with 80's TV.
...
- Dimensions
  ...
  - Borders/Fill: None
  - Final Dimensions: Automatic

- Filters (all OFF for regular film; set like below for 80's TV)

  - Detelecine: Off
  - Interlace Detection: Default
  - Deinterlace: Decomb / Preset: Default
  - Denoise: NLMeans / Preset: Light / Tune: None
  - Chroma Smooth: Off
  - Sharpen: Off
  - Deblock: Off
  - Colorspace: Off
...
- Video
  ...
  - Video Codec: H.265 10-bit NVEnc
  ...
  - Optimize Video:
    ...
    - Encoder Level: Auto
    - Advanced Options: ``rc-lookahead=10``

  - Quality: Constant Quality - 20 for regular content, 22 for 80's TV
...
- Subtitles:
  ...
  - Source: Foreign Audio Scan / Forced Only: Checked / Burn In: Unchecked / Default: Unchecked
  - Source: [First English track] / Forced Only: Unchecked / Burn In: Unchecked / Default: Unchecked
...
- Filters: Everything off. Any filters on will stop NVEnc from being entirely GPU-based.
- Video - Quality: Constant Quality 21
...
- Filters: Everything off. Any filters on will stop NVEnc from being entirely GPU-based.
- Video - Quality: Constant Quality 25
      ...
      "PresetList": [
        {
          ...
          "PresetName": "Illig 4K Film (NVENC - MKV)",
          "SubtitleAddCC": false,
          ...
          "VideoOptionExtra": "rc-lookahead=10:repeat-headers=1:aq-mode=3",
        ...
        },
        {
          ...
          "PresetDescription": "",
          "PresetDisabled": false,
          "PresetName": "Illig HD Film (NVENC - MKV)",
          "SubtitleAddCC": false,
          "SubtitleAddForeignAudioSearch": true,
          "SubtitleAddForeignAudioSubtitle": false,
          "SubtitleBurnBDSub": false,
        ...
        },
        {
          ...
          "PictureUseMaximumSize": false,
          "PresetDisabled": false,
          "PresetName": "Illig SD Film (NVENC - MKV)",
          "SubtitleAddCC": false,
          "SubtitleAddForeignAudioSearch": true,
          "SubtitleAddForeignAudioSubtitle": false,
          "SubtitleBurnBDSub": false,
        ...
        },
        {
          ...
          "PictureTopCrop": 42,
          "PictureUseMaximumSize": false,
          "PresetDescription": "Decomb, light denoise, great for lower-quality 80s TV shows.",
          "PresetDisabled": false,
          "PresetName": "Illig SD 80s TV",
          "SubtitleAddCC": false,
          "SubtitleAddForeignAudioSearch": true,
          "SubtitleAddForeignAudioSubtitle": false,
          "SubtitleBurnBDSub": false,
