...
- At each TV in my house, I have an :doc:`Xbox <hardware/frontend/xbox>` or a :doc:`Chromecast <hardware/frontend/chromecast>` to access the content served by Plex and the various services.
